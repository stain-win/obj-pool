...
import {build, buildFactory, getPool, Poolable} from '@stain-win/objPool';
import {Dummy} from '../../../obj-pool/obj-pool/src/lib/test/dummy';
import {Grumpy} from '../../../obj-pool/obj-pool/src/lib/test/grumpy';
...
export class AppElement extends HTMLElement {
    ...
    constructor() {
        ...
        this.poolDummy.reserve(20);
        this.poolGrumpy.reserve(10);
        this.poolGrumpyF.reserve(10);
        this.poolDummyF.reserve(15);
    }
    ...
    connectedCallback() {
        ...
        this.poolDummy.allocate();
        console.log(this.poolDummyF);
        console.log(this.poolDummy);
        this.poolDummy.release(dum1);
        console.log(dum1);
        console.log(this.poolDummy);
        console.log(getPool(Dummy));
